...
**"Create a comprehensive `.claude` folder setup for my [PROJECT_TYPE] project using [TECH_STACK] in the [PROJECT_DOMAIN] domain with the following detailed specifications:**
...
CONTEXT="Project: [PROJECT_NAME] ([PROJECT_DESCRIPTION])
Stack: [TECH_STACK]
...
AGENT_PROMPT="Analyze these git changes for [PROJECT_CONTEXT].
...
Examples:
feat([component-type]): implement [feature-type] with [technology]

- Add [specific-component] with [optimization]
- Implement [functionality] with [technical-details]
- Add [integration] for [use-case]

fix([area]): resolve [issue-type] in [component]
...
- **Domain Context**: [Business domain and specific requirements]
- **Team Structure**: [Roles and responsibilities]
- **Development Workflow**: [Git/CI/CD patterns]
- **Quality Standards**: [Code standards and review processes]
- **Security Requirements**: [Compliance and security needs]
- **Performance Goals**: [Optimization targets]
- **User Experience**: [UX/accessibility requirements]
...
- **E-commerce project**: Examples like "feat(cart): implement checkout flow with payment integration"
- **CRM system**: Examples like "feat(contacts): implement lead scoring with analytics"
- **Blog platform**: Examples like "feat(editor): implement rich text editing with markdown support"
