    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
          ...
          <div className="space-y-6 p-6 pt-0">
            ...
            <div className="text-center text-sm text-gray-500 space-y-1">
              <div className="flex items-center justify-center gap-1">
                ...
                <span>{locale === 'en' ? 'Secure PIN Authentication' : 'Authentification Sécurisée par Code PIN'}</span>
              </div>
              <div className="flex items-center justify-center gap-1">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                </svg>
                <span>{locale === 'en' ? '8-hour session timeout' : 'Expiration de session de 8 heures'}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-6 text-sm text-gray-500">
          ...
          <p className="mt-1">
            {locale === 'en' ? 'Contact Support' : 'Contacter le Support'}: support@krongthai.com
          </p>
        </div>
      </div>
    </div>
